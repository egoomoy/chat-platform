...
public class JwtUtil {
	...
	public String generateToken(UserDto userDto) {
		return doGenerateToken(userDto, TOKEN_VALIDATION_SECOND);
	}

	public String generateRefreshToken(UserDto userDto) {
		return doGenerateToken(userDto, REFRESH_TOKEN_VALIDATION_SECOND);
	}

	public String doGenerateToken(UserDto userDto, long expireTime) {
		Claims claims = Jwts.claims();
		claims.put("accntId", userDto.getAccntId());
